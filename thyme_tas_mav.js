...
exports.gcs_noti_handler = function (message) {
    ...
    if (ver === 'ff') {
        ...
        mission_value.ch1_raw = SBUS2RC(parseInt(mission_data.substring(34, 36), 16));
        mission_value.ch2_raw = SBUS2RC(parseInt(mission_data.substring(36, 38), 16));
        mission_value.ch3_raw = SBUS2RC(parseInt(mission_data.substring(38, 40), 16));
        mission_value.ch4_raw = SBUS2RC(parseInt(mission_data.substring(40, 42), 16));
        mission_value.ch5_raw = SBUS2RC(parseInt(mission_data.substring(42, 44), 16));
        mission_value.ch6_raw = SBUS2RC(parseInt(mission_data.substring(44, 46), 16));
        mission_value.ch7_raw = SBUS2RC(parseInt(mission_data.substring(46, 48), 16));
        mission_value.ch8_raw = SBUS2RC(parseInt(mission_data.substring(48, 50), 16));
        mission_value.ch9_raw = SBUS2RC(parseInt(mission_data.substring(50, 52), 16));
        mission_value.ch10_raw = SBUS2RC(parseInt(mission_data.substring(52, 54), 16));
        mission_value.ch11_raw = SBUS2RC(parseInt(mission_data.substring(54, 56), 16));
        mission_value.ch12_raw = SBUS2RC(parseInt(mission_data.substring(56, 58), 16));
        mission_value.ch13_raw = SBUS2RC(parseInt(mission_data.substring(58, 60), 16));
...
function rcPortData(message) {
    ...
    while (RCstrFromGCS.length >= RC_LENGTH) {
        ...
        if (header1 === 'ff') {
            ...
            // mission_value.ch17_raw = SBUS2RC(parseInt(mission_data.substring(66, 68), 16));   // CH 1
            // mission_value.ch18_raw = SBUS2RC(parseInt(mission_data.substring(68, 70), 16));   // CH 1
